 ...
 * @see Spinner
 */
public class BPListPopupWindow implements ShowableListMenu {
    ...
    private int buildDropDown() {
        ...
        final int listContent = 1;//mDropDownList.measureHeightOfChildren(childWidthSpec, 0, -1, maxHeight - otherHeights, -1);
        if (listContent > 0) {
