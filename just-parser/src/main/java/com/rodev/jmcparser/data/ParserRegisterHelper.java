...
public class ParserRegisterHelper {
    ...
    public ParserRegisterHelper(LocaleProvider localeProvider, CategoryProvider categoryProvider, DataParser dataParser, AlternateActionProvider alternateActionProvider) {
    ...
    private void registerActionParser() {
        var parser = new ActionParser(localeProvider, categoryProvider, alternateActionProvider);
