...
import com.rodev.jbpcore.blueprint.pin.DragListener;
...
public interface GraphNode extends ChildRoot {
    ...
    void setPinDragListener(DragListener<Pin> listener);
    ...
    void setOnNodePreDrawCallback(Function<GraphNode, Boolean> callback);
