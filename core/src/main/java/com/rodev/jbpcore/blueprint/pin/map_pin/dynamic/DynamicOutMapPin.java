...
import com.rodev.jbpcore.blueprint.pin.map_pin.OutMapPin;

import java.util.HashMap;
import java.util.Map;
import java.util.Objects;

public class DynamicOutMapPin extends OutMapPin implements DynamicMapPin {
    ...
    public DynamicOutMapPin(DynamicMapPinType pinType) {
